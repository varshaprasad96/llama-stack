...
type UserMessage struct {
	...
	// (Optional) This field is used internally by Llama Stack to pass RAG context. This field may be removed in the API in the future.
	Context *InterleavedContent `json:"context,omitempty"`
}
...
// SetContext gets a reference to the given InterleavedContent and assigns it to the Context field.
